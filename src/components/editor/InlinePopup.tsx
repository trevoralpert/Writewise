...
const InlinePopup: React.FC<Props> = ({ rect, suggestion, onClose }) => {
  ...
  const getPopupPosition = () => {
    ...
    const popupWidth = suggestion.type === 'demonetization' ? 288 : 200 // w-72 = 288px
    const popupHeight = suggestion.type === 'demonetization' ? 300 : 100 // estimated
  ...
  return createPortal(
    <div
      ...
      } ${suggestion.type === 'demonetization' ? 'w-80' : 'w-auto'} ${
